...
public class SocketServer implements Runnable {
    ...
    public ServerFrame ui;
    public Database db;
    private String key = AES.generate();
	...
	if (msg.content.equals(".bye")){
            ...
            else if(msg.type.equals("secretkey")) {
            	clients[findClient(ID)].send(new Message("secretkey", msg.recipient, key, msg.sender));
            	//findUserThread(msg.sender).send(new Message("secretkey", "SERVER", key, msg.sender));
            }
